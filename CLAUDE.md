...
- `metacheck` counts the collisions still in the tree as an ADVISORY class
  (`normalized-duplicate-works`, 2,881 groups when it landed, 3,159 once the key's
